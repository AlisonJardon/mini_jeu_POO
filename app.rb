...
# player2.show_state
# sleep 1
# #les sleep me permettent de marquer des temps d'arrêt dans mon code
# puts '
...
# #je place mon break ici pour arrêter ma boucle si mon player 1 se retrouve sans point de vie
